...
namespace TransportationArea.Migrations
{
    ...
    [Migration("20231119221727_AddOrderRoute")]
    partial class AddOrderRoute
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TransportationArea.DBProviderService.Data.OrderRoute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TransportationArea.DBProviderService.Data.Area", b =>
                {
                    b.HasOne("TransportationArea.DBProviderService.Data.OrderRoute", null)
                        .WithMany("route")
            ...
            modelBuilder.Entity("TransportationArea.DBProviderService.Data.Order", b =>
                {
                    ...
                    b.HasOne("TransportationArea.DBProviderService.Data.OrderRoute", "orderRoute")
                        .WithMany()
                        .HasForeignKey("orderRouteId");
